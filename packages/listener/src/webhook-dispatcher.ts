 ...
 * 10 entries cap total attempts at 10. After the last entry the event stays
 * "dead" — no future poll picks it up because next_retry_at is parked 24h out.
 */
 ...
 * After MAX_ATTEMPTS, the event is parked at the last (24h) curve entry — it
 * stops surfacing in `getWebhookEventsDue` polls (effective dead-letter).
 */
